...
\title{A framework for image segmentation with deep neural models on IoT devices}%%%[um subtítulo]
\translatedtitle{Um framework para segmentação de imagens com redes neurais profundas em dispositivos IoT}%%%[a subtitle]

\author{Ciro Batista Rosa}
...
%
\direitos{CC-BY-NC-ND}   %%% ciro: revisar no final
%
...
\begin{tabular}{rl}
	aarch64 & 64-bits ARM microprocessors instruction set architecture\\
	...
	IME & Abbreviation in Portuguese for Institute of Mathematics and Statistics\\
	IoT & Internet of Things\\
	KD & Knowledge Distillation\\
	ML & Machine Learning\\
	RAM & Random Access Memory\\
	RFID & Radio Frequency Identification\\
	RGB & Red, Green, Blue (the basic colors)\\
	SoC & System on Chip\\
	USP & University of São Paulo\\
	WHCN & Width x Height x Channels x Number of images (the four dimensions of a tensor)\\
	x86-64 & 64-bits Intel/AMD microprocessors instruction set architecture\\
\end{tabular}
